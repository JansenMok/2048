...
public class TestMoveTileUp {
    ...
    @Test
    @Tag("moveTileUpAsFarAsPossible")
    @DisplayName("three tiles merge no score")
    public void testThreeTilesMergeNoScore() {
        int[][] board = {
                {2, 0, 0, 0},
                {2, 0, 0, 0},
                {0, 0, 0, 0},
...
//    dont think im supposed to pass this test yet lmao
//    this is a tilt column test, moved to TestTiltColumn.java
//    @Test
//    @Tag("moveTileUpAsFarAsPossible")
//    @DisplayName("four tiles merge no score")
//    public void testFourTilesMergeNoScore() {
//        int[][] board = {
//                {2, 0, 0, 0},
//                {2, 0, 0, 0},
//                {2, 0, 0, 0},
